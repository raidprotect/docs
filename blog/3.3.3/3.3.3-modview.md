...
La version 3.3.3 complète la **boîte à outils du modérateur** : une nouvelle **vue de modération centralisée**, des sanctions enrichies (softban, option silent, rôle de Jail) et plusieurs ajustements anti-raid et anti-spam.
