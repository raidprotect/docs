...
| **Grade** | **Condition**                         |
| --------- | ------------------------------------- |
| S          | Au moins une passkey enregistrée      |
| A          | Code OTP (2FA) activé                 |
| B          | PIN renforcé de 8 chiffres ou plus    |
| C          | PIN renforcé de 6 chiffres ou plus    |
| D          | PIN simple de 6 chiffres ou plus      |
| E          | PIN simple de 4 chiffres ou plus      |
