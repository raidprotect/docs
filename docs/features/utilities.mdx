...
La commande `/discord-sanctions` vous permet de visualiser les **sanctions émises par Discord** à l’encontre d’un utilisateur, conformément à la réglementation européenne.
...
- **Type de sanction** (suppression de contenu, compte restreint/suspendu/banni)
- **Date d’émission**
- **Type de contenu**
- **Flags** (🚓 illégal, 🤖 automatique)

:::note
Ces informations sont directement fournies par Discord et **ne peuvent pas être modifiées** par RaidProtect.
:::