...
| ---------------------------------------- | ---------------------------- | ----------------------------------------------------------------- |
| `DID_REJOIN`                             | <img  src="./assets/icons/MemberDidRejoin.svg"  alt="icon MemberDidRejoin" title=":MemberDidRejoin:"/>              | L'utilisateur a quitté et rejoint à nouveau le serveur.           |
...
| `STARTED_ONBOARDING`                     | OnboardingStarted            | A commencé le processus d'accueil.                                |
| `COMPLETED_SERVER_GUIDE`                 | ServerGuideCompleted         | A terminé le guide du serveur si activé.                          |
| `STARTED_SERVER_GUIDE`                   | ServerGuideStarted           | A commencé le guide du serveur.                                   |
| `AUTOMOD_QUARANTINED_NAME`               | MemberQuarantined            | Mis en quarantaine par l'automodération pour le nom d'utilisateur.|
| `AUTOMOD_QUARANTINED_GUILD_TAG`          | MemberQuarantined            | Mis en quarantaine par l'automodération pour le tag ou pseudo.    |
