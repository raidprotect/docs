...
<br />
<DocCard item={{ type: 'link', href: '/beta/features', docId: 'features', label: 'Les fonctionnalités' }} />
<br />
<DocCard item={{ type: 'link', href: '/beta/guides', docId: 'guides', label: 'Nos guides' }} />
<br />
<DocCard item={{ type: 'link', href: '/beta/useful-links', docId: 'useful-links', label: 'Liens utiles' }} />
<br />