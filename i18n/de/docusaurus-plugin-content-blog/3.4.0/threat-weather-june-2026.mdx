...
Bisher hat ScamLens, wenn ein gehacktes Konto seine Welle ausschüttete, **zuerst alle Nachrichten entfernt** und dann sanktioniert. Während dieser Bereinigung konnte das Konto noch einige Sekunden weitermachen, und diese Wellen **enthielten manchmal Rollen-Erwähnungen**, die den Server mit Benachrichtigungen überfluteten.

Jetzt **löscht und sanktioniert** RaidProtect schon beim **ersten erkannten Scam-Bild sofort** (konfigurierbare Sanktion) und bereinigt *danach* den Rest. Das gehackte Konto wird auf der Stelle gekappt, ohne Zeit, weitere Bilder zu posten oder den Server zu pingen.
    ...
    {JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Seit Juni 2026 sanktioniert ScamLens das Konto bereits beim ersten erkannten Scam-Bild (konfigurierbare Sanktion) und bereinigt danach den Rest der Welle. Zuvor wurden erst alle Nachrichten gelöscht, bevor sanktioniert wurde, was ein gehacktes Konto noch einige Bilder mehr posten ließ.',
          },
        },
        {
          '@type': 'Question',
...
Seit Juni 2026 **sanktioniert ScamLens das Konto bereits beim ersten** erkannten Scam-Bild (konfigurierbare Sanktion) und bereinigt *danach* den Rest der Welle. Zuvor wurden erst alle Nachrichten gelöscht, bevor sanktioniert wurde, was ein gehacktes Konto noch einige Bilder mehr posten ließ.
