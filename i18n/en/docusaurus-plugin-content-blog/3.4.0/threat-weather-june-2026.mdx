...
![RaidProtect: Threat Weather June 2026](./assets/rp-scamlens-4-month-recap.webp)
    ...
    {JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Since June 2026, ScamLens sanctions the account on the very first detected scam image (configurable sanction), then cleans up the rest of the wave. Before, it deleted all the messages first before sanctioning, which let a hacked account post a few more images.',
          },
        },
        {
          '@type': 'Question',
