...
- New feature **[Sanctions History](./features/sanctions.md)**.
  - New [command `/sanctions search`](./features/sanctions.md#search).
  - New [command `/sanctions info`](./features/sanctions.md#info).
  - New [command `/sanctions edit`](./features/sanctions.md#edit).
  - New [command `/sanctions delete`](./features/sanctions.md#delete).
...
- New [command `/warn`](./features/moderation.md#warn). <SuggestionLink id="52" />
- New [command `/untimeout`](./features/moderation.md#untimeout). <SuggestionLink id="52" />
- New [command `/tempban`](./features/moderation.md#tempban). <SuggestionLink id="524" />
...
- New [command `/joinlock`](./features/channel-lock.md#joinlock) to close invites indefinitely.
...
- New [command `/slowmode`](./features/moderation.md#slowmode) to enable or modify the slowmode of a channel.
- New [command `/unban`](./features/moderation.md#unban). <SuggestionLink id="296" />
