...
- [RaidMode](./features/raid-mode.md#mode-raid) and [Auto RaidMode](./features/raid-mode.md#duration) automatically deactivate after a certain time. <SuggestionLink id="37" />
- New [duration] parameter for the [command `/raidmode`](./features/raid-mode.md#mode-raid). <SuggestionLink id="37" />
