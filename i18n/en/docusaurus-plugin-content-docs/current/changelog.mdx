...
- Fixes:
  ...
  - Errors handling the reason in the /timeout command.
  - Multiple optimizations to reduce bot startup time and command execution time.
  - Errors in interpreting prefix commands.
  - Errors in prefix validation.
  - Default avatar errors fixed.
