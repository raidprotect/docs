...
- Choice of [sanctions](./features/anti-spam.md#triggers) applied by the anti-spam. <SuggestionLink id="514" />
- New anti-spam logs (better visibility on detections).
- Enable minimum account age without captcha. <SuggestionLink id="314" />
- Blocking/allowing certain file extensions server-wide.
- Complete redesign of the [`/userinfo` command](./features/utilities.md#userinfo).
...
- Fixes:
  ...
  - Fixed bug in the [`/clear` command](./features/utilities.md#clear) when the bot lacked necessary permissions in a channel.
- Improved UI/UX:
...
- Performance and stability:
  - Revamped emoji handling (via @fca.gg/glyph v1.0.0).
  - Reduced startup time and cluster monitoring (via @fca.gg/midway v1.3.1).
  - Better rate limit handling and reduced latency (via @fca.gg/iris v1.1.4).
  - Integrated Sentry for error tracking and improved developer support (@fca.gg/kino v1.0.0).
