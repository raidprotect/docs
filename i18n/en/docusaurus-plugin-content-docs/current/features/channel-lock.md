...
{/* <ChannelLockMockup /> : hidden for now */}
...
By default, this feature is disabled. However, you can choose whether locked channels should be renamed with a lock emoji (🔒) added before their name.
