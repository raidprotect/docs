...
<DocCard item={{ type: 'link', href: '/', label: 'Read Me' }} />
<br />
...
<DocCard item={{ type: 'link', href: '/features/raid-mode', label: 'Raid Mode' }} />
...
<DocCard item={{ type: 'link', href: '/features/captcha', label: 'Captcha (Verification)' }} />
...
<DocCard item={{ type: 'link', href: '/malfunctions', label: 'Common Issues' }} />