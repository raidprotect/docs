...
| `STARTED_ONBOARDING`                     | OnboardingStarted            | Started onboarding.                                                |
| `COMPLETED_SERVER_GUIDE`                 | ServerGuideCompleted         | Completed the server guide if enabled.                             |
| `STARTED_SERVER_GUIDE`                   | ServerGuideStarted           | Started the server guide.                                          |
| `AUTOMOD_QUARANTINED_NAME`               | MemberQuarantined            | Quarantined by automod for username.                               |
| `AUTOMOD_QUARANTINED_GUILD_TAG`          | MemberQuarantined            | Quarantined by automod for tag or nickname.                        |
