...
El anti-spam de RaidProtect detecta y sanciona automáticamente el [spam](/es/learn/spam-discord) en tu servidor de Discord: mensajes repetidos, menciones masivas, flood y envío masivo de enlaces, sin que un moderador tenga que intervenir. Gracias a su detección automática, se encarga de los problemas por sí solo.
...
Estas son las diferentes **[sanciones disponibles](/es/learn/discord-sanctions)**:
...
| Spam con selfbot                       | Uso de [selfbots](/es/learn/self-bot) para hacer spam    | Softban             |
| Spam de menciones                      | Menciones masivas repetidas                              | Softban             |
| Spam de enlaces                        | Envio masivo de enlaces                                  | Baneo               |
| Spam de comandos externos              | Uso de [comandos externos](/es/learn/server-raidable) para hacer spam                 | Baneo               |
