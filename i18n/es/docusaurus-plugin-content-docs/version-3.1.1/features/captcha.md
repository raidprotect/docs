...
Configurar el captcha es rapido y sencillo.
...
![Captura de pantalla de la configuracion del captcha](../../../../en/docusaurus-plugin-content-docs/version-3.1.1/assets/rp-settings-captcha.webp)
