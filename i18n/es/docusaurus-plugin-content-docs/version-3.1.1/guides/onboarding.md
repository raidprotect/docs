...
1. Ve a **Ajustes del Servidor** > **Bienvenida**.
...
3. Ingresa el codigo del Captcha enviado por RaidProtect.
...
| Problema | Solucion |
|----------|----------|
| 🔴 El canal `#verification` permanece invisible | Verifica que este en una **categoria marcada** en los ajustes de Bienvenida de Discord. |
| 🚫 El rol `@Unverified` no puede escribir | Otorgale permiso de **enviar mensajes** en `#verification`. |
