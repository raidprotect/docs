...
Si prefieres usar ciertos comandos con un prefijo personalizado, puedes habilitar esta opcion. El prefijo predeterminado cuando se activa es `?`, pero puede modificarse segun tus necesidades. Una vez activado, estos comandos se pueden usar con el prefijo configurado:
...
![Captura de pantalla de la configuracion del prefijo](../../../../en/docusaurus-plugin-content-docs/version-3.1.1/assets/rp-settings-prefix.webp)
