---
title: 'Como proteger o teu servidor de Discord do spam de imagens de scam: sanção logo na primeira imagem'
tags: [threats]
authors: [zallom]
...
![RaidProtect: Meteorologia das ameaças Junho 2026](../../../../blog/3.4.0/assets/rp-scamlens-4-month-recap.webp)
...
Até agora, quando uma conta pirateada despejava a sua vaga, o ScamLens **removia primeiro todas as mensagens** e só depois sancionava. Durante essa limpeza, a conta podia continuar alguns segundos, e essas vagas **incluíam por vezes menções de cargos** que inundavam o servidor de notificações.

Agora, logo na **primeira imagem de scam** detetada, o RaidProtect **remove e sanciona imediatamente** (sanção configurável) e *depois* limpa o resto. A conta pirateada é cortada na hora, sem tempo de publicar mais nem de pingar o servidor.
    ...
    {JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Desde junho de 2026, o ScamLens sanciona a conta logo na primeira imagem de scam detetada (sanção configurável) e depois limpa o resto da vaga. Antes removia primeiro todas as mensagens antes de sancionar, o que deixava uma conta pirateada publicar mais algumas imagens.',
          },
        },
        {
          '@type': 'Question',
...
Desde junho de 2026, o ScamLens **sanciona a conta logo na primeira** imagem de scam detetada (sanção configurável) e *depois* limpa o resto da vaga. Antes removia primeiro todas as mensagens antes de sancionar, o que deixava uma conta pirateada publicar mais algumas imagens.
