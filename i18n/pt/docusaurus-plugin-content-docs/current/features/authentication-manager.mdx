...
O Authentication Manager (AM) do RaidProtect é um sistema de autenticação avançado que protege o acesso a determinados cargos do Discord através de uma verificação de identidade. Graças às passkeys (WebAuthn), códigos PIN e OTP, apenas os membros autenticados podem obter [cargos sensíveis](/pt/learn/least-privilege).
