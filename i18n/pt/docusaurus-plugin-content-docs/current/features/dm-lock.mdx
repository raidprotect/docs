...
description: "O Bloqueio de DMs do RaidProtect fecha de forma duradoura as mensagens privadas vindas do seu servidor Discord, um escudo contra spam e golpes."
---
