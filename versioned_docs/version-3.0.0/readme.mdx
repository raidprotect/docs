...
:::note Afin d'assurer son bon fonctionnement, accordez bien la permission **Administrateur** à RaidProtect. Cela lui permet de modérer automatiquement tous vos salons.
...
:::note **Si le salon de logs ne s'est pas créé de lui-même**, il sera nécessaire d'effectuer la commande `?setup` dans votre serveur pour l'initialiser manuellement le bot.
